<div id="sidebar"
    class="fixed inset-y-0 left-0 w-64 bg-purple-900 text-white flex flex-col shadow-xl flex-shrink-0 z-40 transition-all duration-300 transform -translate-x-full md:translate-x-0 md:relative">
    <div class="p-6 border-b border-purple-800 flex justify-between items-center">
        ...
        <button id="sidebar-close" class="md:hidden p-2 text-purple-200 hover:text-white">
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-1" id="sidebar-nav">
        <button data-tab="dashboard"
            class="sidebar-btn w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors text-sm font-medium bg-purple-800 text-white"><i
    ...
    <div class="mt-auto border-t border-purple-800 bg-purple-950 p-4">
        <div class="flex items-center space-x-3 mb-4">
            <div
                class="h-10 w-10 bg-purple-700 rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0">
