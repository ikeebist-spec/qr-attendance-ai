...
<div id="tab-scan" class="tab-content">
    <div class="flex flex-col items-center max-w-2xl mx-auto">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 w-full text-center">
            ...
            <div class="mb-6 inline-block bg-blue-50 border border-blue-200 text-blue-800 px-4 py-2 rounded-lg text-sm font-medium">
                Currently Scanning For: <span id="scan-event-name" class="font-bold">...</span>
            </div>
            
            <div class="rounded-xl overflow-hidden border-2 border-gray-200 w-full max-w-md mx-auto bg-white mb-8">
