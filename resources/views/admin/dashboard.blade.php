...
<div id="tab-dashboard" class="tab-content active space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
        ...
        <div class="space-x-4">
            <button onclick="window.switchTab('scan')" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-colors">Open Scanner</button>
