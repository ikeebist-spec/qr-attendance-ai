...
<div id="tab-events" class="tab-content space-y-6">
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <form id="add-event-form" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <input required id="event-date" type="date" class="border p-2 rounded focus:ring-2 focus:ring-blue-500 outline-none" />
            <select id="event-type" class="border p-2 rounded focus:ring-2 focus:ring-blue-500 outline-none">
